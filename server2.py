...
class LMSService(lms_pb2_grpc.LMSServicer):
    def __init__(self, node_id, peers):
        ...
        self.leader_id = None
        self.election_timeout = random.uniform(5, 8)  # Random timeout between 5-10 seconds
    ...
    def AppendEntries(self, request, context):
        ...
        # Append new entries if provided (normally this would include conflict resolution logic)
            if request.entries:
                ...
                assignment_counter = self.log[-1].grade_entry.assignment_id + 1
    ...
    def send_append_entries(self, peer,log_entry,heartbeat = False):
        ...
        with grpc.insecure_channel(peer) as channel:
            ...
            try:
                ...
                if response.success:
                    print(f"Heartbeat sent to peer {peer}")
                else:
                    print(f"Failed to send heartbeat to peer {peer}")
...
if __name__ == "__main__":
    node_id=2
    peers = ['0.0.0.0:50051','0.0.0.0:50053']
    serve()
